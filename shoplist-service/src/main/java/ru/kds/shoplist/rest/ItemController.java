 ...
 */
@RestController
@RequestMapping("/api/v1/shoplist/{shoplistId}/items")
public class ItemController {
     ...
     */
    @PostMapping
    public ItemCreateResponse createItem(@PathVariable("shoplistId") Long shoplistId, @Valid ItemCreateRequest request)
    ...
    public void checkItem(@PathVariable("shoplistId") Long shoplistId, @PathVariable("id") Long id)
            throws ObjectNotFoundException {
        itemService.checkItem(shoplistId, id, true);
    }
    ...
    public void uncheckItem(@PathVariable("shoplistId") Long shoplistId, @PathVariable("id") Long id)
            throws ObjectNotFoundException {
        itemService.checkItem(shoplistId, id, false);
    }
     ...
     */
    @DeleteMapping("{id}")
    public void deleteItem(@PathVariable("shoplistId") Long shoplistId, @PathVariable("id") Long id)
            throws ObjectNotFoundException {
        itemService.deleteItem(shoplistId, id);
    }
    ...
    public PageResponse<ItemRest> findItems(@PathVariable("shoplistId") Long shoplistId, Pageable pageable)
            throws ObjectNotFoundException {
        Page<Item> items = itemService.findItems(shoplistId, pageable);
